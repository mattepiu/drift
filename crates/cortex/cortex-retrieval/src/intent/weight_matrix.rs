...
impl WeightMatrix {
    ...
    pub fn default_weights() -> Self {
        ...
        weights.insert(Intent::FixBug, Self::build_map(&[
        ...
        weights.insert(Intent::AddFeature, Self::build_map(&[
        ...
        weights.insert(Intent::Refactor, Self::build_map(&[
        ...
        weights.insert(Intent::SecurityAudit, Self::build_map(&[
        ...
        weights.insert(Intent::UnderstandCode, Self::build_map(&[
        ...
        weights.insert(Intent::AddTest, Self::build_map(&[
            (MemoryType::PatternRationale, 1.8),
            (MemoryType::CodeSmell, 1.5),
            (MemoryType::ConstraintOverride, 1.3),
        ]));
        ...
        weights.insert(Intent::ReviewCode, Self::build_map(&[
            (MemoryType::PatternRationale, 1.8),
            (MemoryType::Tribal, 1.5),
            (MemoryType::CodeSmell, 1.5),
        ]));
        ...
        weights.insert(Intent::DeployMigrate, Self::build_map(&[
        ...
        weights.insert(Intent::Recall, Self::build_map(&[
            (MemoryType::Core, 1.2),
            (MemoryType::Tribal, 1.2),
        ]));

        // Investigate: boost incidents, decisions, tribal.
        weights.insert(Intent::Investigate, Self::build_map(&[
        ...
        weights.insert(Intent::Decide, Self::build_map(&[
        ...
        weights.insert(Intent::Learn, Self::build_map(&[
        ...
        weights.insert(Intent::Summarize, Self::build_map(&[
            (MemoryType::Core, 1.5),
        ...
        weights.insert(Intent::Compare, Self::build_map(&[
        ...
        weights.insert(Intent::Create, Self::build_map(&[
            (MemoryType::PatternRationale, 1.8),
